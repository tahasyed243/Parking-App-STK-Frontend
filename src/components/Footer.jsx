...
export default function Footer() {
    ...
    const socialLinks = [
        {
            name: "Facebook",
            url: "https://www.facebook.com/syed.taha.39566",
            icon: (
        ...
        {
            name: "LinkedIn",
            url: "https://www.linkedin.com/in/syed-taha-86b05a295/",
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
        ...
        {
            name: "Instagram",
            url: "https://www.instagram.com/syed_taha2005/",
            icon: (
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8 mb-8">
                    ...
                    <div className="lg:col-span-2">
                        ...
                        <p className="text-gray-400 mb-6 max-w-md">
                            Making cities smarter by eliminating parking stress. Join thousands of users who save time and money every day.
                        </p>
                        <div className="flex gap-4">
                            {socialLinks.map((social) => (
                                <a
                                    ...
                                    className="w-10 h-10 bg-gray-800 rounded-full flex items-center justify-center hover:bg-cyan-700 hover:text-white transition transform hover:scale-110"
                ...
                <div className="mb-8 p-6 bg-gray-800/50 rounded-xl border border-gray-700">
                    ...
                    <div className="grid md:grid-cols-2 gap-4">
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-gray-300">tahasyed243@gmail.com</span>
                        </div>
                        <div className="flex items-center gap-3">
                            <svg className="w-5 h-5 text-cyan-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
